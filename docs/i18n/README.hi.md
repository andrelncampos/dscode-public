...
**पूर्वापेक्षा**: [Node.js](https://nodejs.org) संस्करण **24** या उच्चतर।
...
| Command | Description |
|---|---|
| `/model` | 3 प्रदाताओं के 11 मॉडलों में से चुनें, प्रोवाइडर-अनुरूप thinking mode और reasoning effort के साथ |
...
| **मॉडल** | विशिष्ट AI मॉडल (जैसे `deepseek-v4-pro`, `gpt-5.5`, `claude-sonnet-4-6`)। 3 प्रोवाइडर के 11 मॉडल उपलब्ध। | विभिन्न मॉडलों की गुणवत्ता, गति और लागत अलग-अलग होती है। |
