...
[रिलीज़ पेज](https://github.com/andrelncampos/dscode-public-public/releases) से बाइनरी डाउनलोड करें, निकालें और `./dscode` चलाएं। **Node.js 24+ आवश्यक है।**
...
| `#` | नाम से skill सक्रिय करें (skill मेनू) |
...
| **नोट रिकॉर्ड करना** | टैग, linked spec और देय तिथि के साथ विकास नोट बनाने के लिए `/notes-add` टाइप करें। |
...
| **नोट्स** | DsCode में निर्मित नोट-लेखन प्रणाली। टैग, spec लिंकिंग और देय तिथियों के साथ तकनीकी ऋण, विचार और कार्य रिकॉर्ड करें। | संदर्भ खोने से बचने के लिए विकास के दौरान `/notes-add` का उपयोग करें। नोट्स `.dscode/notes.json` में संग्रहीत हैं। |
...
यह प्रोजेक्ट [DeepCode (lessweb/deepcode-cli)](https://github.com/lessweb/deepcode-cli) से लिया गया है, मूल रूप से MIT लाइसेंस प्राप्त है। मूल कॉपीराइट नोटिस [LICENSE](../LICENSE) और [NOTICE](../CHANGELOG.md) में संरक्षित है।

तृतीय-पक्ष निर्भरताएं अपने स्वयं के लाइसेंस बनाए रखती हैं। निर्भरता सूची और लाइसेंस के लिए [NOTICE](../CHANGELOG.md) देखें।
