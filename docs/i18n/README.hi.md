...
| Piece | What it does | Why it is unique |
|---|---|---|
...
| **Agent** | Skills run as isolated subagents with independent model, tools, and thinking | Agents use MCP, follow steering rules, and do not pollute the main context |
