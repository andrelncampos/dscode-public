...
> ⚠️ **अभी तक कोई release प्रकाशित नहीं हुआ है।** नीचे दिए गए निर्देश पहली release प्रकाशित होने पर डाउनलोड प्रारूप दिखाते हैं। तब तक, ऊपर दिए गए npm इंस्टॉलेशन का उपयोग करें।

[GitHub Releases पेज](https://github.com/andrelncampos/dscode/releases) से बाइनरी डाउनलोड करें। Node.js की आवश्यकता नहीं — बाइनरी स्व-निहित है।
...
DsCode अपनी कॉन्फ़िगरेशन `~/.dscode/settings.json` (आपकी होम डायरेक्टरी में) से पढ़ता है। आप स्थानीय सेटिंग्स के लिए किसी विशिष्ट प्रोजेक्ट के अंदर `.dscode/settings.json` भी रख सकते हैं।

### अपनी पहली कॉन्फ़िगरेशन बनाना

`~/.dscode/settings.json` बनाएं:
...
कमांड मेनू खोलने के लिए प्रॉम्प्ट में `/` टाइप करें:

| कमांड | कार्य |
|---|---|
| `/model` | मॉडल, thinking mode और reasoning effort चुनें |
| `/new` | नई बातचीत शुरू करें (संदर्भ साफ़ करता है) |
| `/init` | प्रोजेक्ट में AI के लिए निर्देशों के साथ `AGENTS.md` फ़ाइल बनाएं |
| `/resume` | पिछली बातचीत फिर से शुरू करें |
| `/continue` | सक्रिय बातचीत जारी रखें (या खाली होने पर फिर से शुरू करें) |
| `/undo` | कोड या बातचीत को पिछले बिंदु पर पुनर्स्थापित करें |
| `/mcp` | MCP सर्वर स्थिति और उपलब्ध टूल्स दिखाएं |
| `/raw` | रीज़निंग प्रदर्शन मोड टॉगल करें (पूर्ण, सारांश, छिपा हुआ) |
| `/exit` | DsCode से बाहर निकलें |
...
| `Ctrl+Z` | अंतिम प्रॉम्प्ट संपादन पूर्ववत करें |
| `Ctrl+Shift+Z` | प्रॉम्प्ट संपादन फिर से करें |
| `Ctrl+W` | पिछला शब्द हटाएं |
| `Ctrl+A` | पंक्ति की शुरुआत में जाएं |
...
| `?` | सभी शॉर्टकट के साथ सहायता स्क्रीन खोलें/बंद करें |
