...
**Pré-requisito**: [Node.js](https://nodejs.org) versão **24** ou superior.
...
| **Compactação** | Usa `getCheapModel()`: `gpt-5.4` → `gpt-5.4-mini` para reduzir custo ao resumir histórico |
