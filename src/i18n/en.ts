const enDictionary = {
  ...
  "cmd.image-upload": "Attach an image file from disk into the current prompt",
  ...
  "cmd.notes-add": "Create a quick note/reminder with optional deadline and tags",
  "cmd.notes-add-usage": "Usage: /notes-add <text> [--deadline YYYY-MM-DD] [--tag <tag>] [--spec <id>]",
  "cmd.notes-deadline": "Set, change, or remove note deadline",
  "cmd.notes-deadline-removed": "Note {{id}} deadline removed.",
  "cmd.notes-deadline-set": "Note {{id}} deadline set.",
  "cmd.notes-deadline-usage": "Usage: /notes-deadline <id> <YYYY-MM-DD> | --remove",
  "cmd.notes-delete": "Delete a note by its short ID",
  "cmd.notes-delete-usage": "Usage: /notes-delete <id>",
  "cmd.notes-deleted": "Note {{id}} deleted.",
  "cmd.notes-edit": "Edit note text in-place",
  "cmd.notes-edit-usage":
    'Usage: /notes-edit <id> ["text"] [--tag <tag>] [--deadline YYYY-MM-DD] [--spec <id>] [--spec-remove]',
  "cmd.notes-invalid-date": "Invalid date format. Use YYYY-MM-DD.",
  "cmd.notes-invalid-status": "Invalid status. Use: open, closed, paused, abandoned.",
  "cmd.notes": "List notes filtered by status, overdue, or linked spec",
  "cmd.notes-empty": "No notes found. Use /notes-add <text> to create one.",
  "cmd.notes-not-found": "Note {{id}} not found.",
  "cmd.notes-status": "Change note status (open, closed, paused, abandoned)",
  "cmd.notes-status-changed": "Note {{id}} status: {{from}} → {{to}}.",
  ...
  "help.skills-cmd": "List available skills",
  "help.cls-cmd": "Clear screen",
  "help.init-cmd": "Initialize AGENTS.md with project instructions",
  "help.continue-cmd": "Continue current conversation",
  "help.notes-add-cmd": "Add a developer note",
  "help.notes-cmd": "List notes (--status, --overdue, --spec)",
  "help.notes-status-cmd": "Change note status (open|closed|paused|abandoned)",
  "help.notes-edit-cmd": "Edit note text, tags, spec, or deadline",
  "help.notes-deadline-cmd": "Set or remove note deadline",
  "help.notes-delete-cmd": "Delete a note permanently",
  "help.steering-add-cmd": "Add steering instruction",
  "help.steering-list-cmd": "List steering instructions",
  "help.steering-remove-cmd": "Remove a steering instruction",
  "help.steering-alter-cmd": "Modify a steering instruction",
  "help.spec-init-cmd": "Initialize spec-driven-development structure",
  "help.spec-plan-cmd": "Plan a new spec",
  "help.spec-new-cmd": "Create a new spec from requirements",
  ...
  "help.model-add-cmd": "Add a custom model",
  "help.model-remove-cmd": "Remove a custom model",
  "help.model-info-cmd": "Show model capabilities and pricing",
  "help.model-key-cmd": "Set API key for a provider",
  "help.model-default-cmd": "Set default model",
  "help.model-params-cmd": "Change generation parameters",
  "help.model-thinking-cmd": "Configure thinking/reasoning mode",
  "help.budget-cmd": "Show session cost and token usage",
