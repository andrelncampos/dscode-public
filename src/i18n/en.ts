const enDictionary = {
  ...
  "cmd.note-deadline-removed": "Note {{id}} deadline removed.",
  "cmd.note-deadline-set": "Note {{id}} deadline set.",
  "cmd.note-deadline-usage": "Usage: /note-deadline <id> <YYYY-MM-DD> | --remove",
  "cmd.note-delete": "Delete a note by its short ID",
  "cmd.note-delete-usage": "Usage: /note-delete <id>",
  "cmd.note-deleted": "Note {{id}} deleted.",
  "cmd.note-edit": "Edit note text in-place",
  "cmd.note-edit-usage":
    'Usage: /note-edit <id> ["text"] [--tag <tag>] [--deadline YYYY-MM-DD] [--spec <id>] [--spec-remove]',
  "cmd.note-invalid-date": "Invalid date format. Use YYYY-MM-DD.",
  "cmd.note-invalid-status": "Invalid status. Use: open, closed, paused, abandoned.",
  "cmd.note-list": "List notes filtered by status, overdue, or linked spec",
  "cmd.note-list-empty": "No notes found. Use /note-add <text> to create one.",
  "cmd.note-not-found": "Note {{id}} not found.",
  "cmd.note-status": "Change note status (open, closed, paused, abandoned)",
  "cmd.note-status-changed": "Note {{id}} status: {{from}} → {{to}}.",
  "cmd.note-status-usage": "Usage: /note-status <id> <status>",
  "cmd.note-updated": "Note {{id}} updated.",
  ...
  "help.note-add-cmd": "Add a developer note",
  "help.note-list-cmd": "List notes (--status, --overdue, --spec)",
  "help.note-status-cmd": "Change note status (open|closed|paused|abandoned)",
  "help.note-edit-cmd": "Edit note text, tags, spec, or deadline",
  "help.note-deadline-cmd": "Set or remove note deadline",
  "help.note-delete-cmd": "Delete a note permanently",
